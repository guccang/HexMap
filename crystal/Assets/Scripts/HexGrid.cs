...
public class HexGrid : MonoBehaviour {
	...
	public int seed;
    float []MoveCost_Elevation;
    float[] MoveCost_Terrain;
    float[] MoveCost_Building;
    ...
    void InitMoveCost()
    {
        ...
        // elevation
        MoveCost_Elevation = new float[vary];
        for (int i = 0; i < vary; ++i)
        {
            MoveCost_Elevation[i] = (i * 5) + 1;
        }

        // terrain
        MoveCost_Terrain = new float[vary];
        for(int i=0; i<vary;++i)
        {
            MoveCost_Terrain[i] = i + 1 ;
        }

        // building
        MoveCost_Building = new float[vary];
        for(int i=0;i<vary; ++i)
        {
            MoveCost_Building[i] = i;
        }
    }
